...
exports.yuniq = void 0;
var react_1 = __importDefault(require("react"));
var ink_1 = require("ink");
exports.yuniq = function () {
	return react_1.default.createElement(
		ink_1.Box,
		{ margin: 1, padding: 2, flexDirection: "column" },
		react_1.default.createElement(
			ink_1.Box,
			{ marginBottom: 1, alignItems: "center" },
			react_1.default.createElement(ink_1.Color, { cyan: true }, "Hello, "),
			react_1.default.createElement(ink_1.Color, { cyanBright: true }, "I'm "),
			react_1.default.createElement(
				ink_1.Color,
				{ bgBlue: true, white: true },
				react_1.default.createElement(ink_1.Text, { bold: true }, " yuni-q ")
			),
